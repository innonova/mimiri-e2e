...
export interface LinuxNativeDialog {
  windowId: string;
...
export function linuxDialogSupport(): boolean {
  return (
...
function readGeometry(windowId: string): LinuxNativeDialog["geometry"] {
...
export async function cancelDialog(dialog: LinuxNativeDialog): Promise<void> {
  xdo("windowactivate", "--sync", dialog.windowId);
